...
from App.domain.schemas.province_schema import (Add_province,massage_province,massage,get_name)
...
class ProvinceService(BaseService):
    ...
    async def get_province_id(self,province_id:UUID):
        province=self.province_repository.get_province_name_by_id(province_id)
        return get_name(province_name=province.province_name)