...
class Add_sell_car_form(BaseModel):
    car_name:str = Field(..., max_length=100,min_length=5)
    model_id:UUID
    ...
    description:Optional[str]= Field(None, max_length=300,min_length=0)
    city_id:UUID
...
class updata_sell_car(get_sell_car_id):
    car_name:Optional[str] = Field(None, max_length=100,min_length=5)
    model_id:Optional[UUID]=None
    price:Optional[int]=Field(None, ge=5000000)
    color:Optional[str]= Field(None, max_length=100,min_length=2)
